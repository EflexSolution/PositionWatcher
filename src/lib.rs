// src/lib.rs
/*
 * Core library for PositionWatcher
 */
...
#[derive(Debug)]
pub struct PositionWatcherProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PositionWatcherProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PositionWatcher processing");
    
    let mut processor = PositionWatcherProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PositionWatcherProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PositionWatcherProcessor::new(false);
